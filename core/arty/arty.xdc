...
connect_debug_port u_ila_0/probe1 [get_nets [list {uart_dout[0]} {uart_dout[1]} {uart_dout[2]} {uart_dout[3]} {uart_dout[4]} {uart_dout[5]} {uart_dout[6]} {uart_dout[7]} {uart_dout[8]} {uart_dout[9]} {uart_dout[10]} {uart_dout[11]} {uart_dout[12]} {uart_dout[13]} {uart_dout[14]} {uart_dout[15]} {uart_dout[16]} {uart_dout[17]} {uart_dout[18]} {uart_dout[19]} {uart_dout[20]} {uart_dout[21]} {uart_dout[22]} {uart_dout[23]} {uart_dout[24]} {uart_dout[25]} {uart_dout[26]} {uart_dout[27]} {uart_dout[28]} {uart_dout[29]} {uart_dout[30]} {uart_dout[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 32 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {insn_din[0]} {insn_din[1]} {insn_din[2]} {insn_din[3]} {insn_din[4]} {insn_din[5]} {insn_din[6]} {insn_din[7]} {insn_din[8]} {insn_din[9]} {insn_din[10]} {insn_din[11]} {insn_din[12]} {insn_din[13]} {insn_din[14]} {insn_din[15]} {insn_din[16]} {insn_din[17]} {insn_din[18]} {insn_din[19]} {insn_din[20]} {insn_din[21]} {insn_din[22]} {insn_din[23]} {insn_din[24]} {insn_din[25]} {insn_din[26]} {insn_din[27]} {insn_din[28]} {insn_din[29]} {insn_din[30]} {insn_din[31]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe8 [get_nets [list data_we]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe9]
set_property port_width 1 [get_debug_ports u_ila_0/probe9]
connect_debug_port u_ila_0/probe9 [get_nets [list insn_we]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe10]
set_property port_width 1 [get_debug_ports u_ila_0/probe10]
connect_debug_port u_ila_0/probe10 [get_nets [list run]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe11]
set_property port_width 1 [get_debug_ports u_ila_0/probe11]
connect_debug_port u_ila_0/probe11 [get_nets [list run_d]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe12]
set_property port_width 1 [get_debug_ports u_ila_0/probe12]
connect_debug_port u_ila_0/probe12 [get_nets [list uart_rx_rd]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe13]
set_property port_width 1 [get_debug_ports u_ila_0/probe13]
connect_debug_port u_ila_0/probe13 [get_nets [list uart_rx_rd_d]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe14]
set_property port_width 1 [get_debug_ports u_ila_0/probe14]
connect_debug_port u_ila_0/probe14 [get_nets [list uart_we]]
